...
export class MultiversXService {
  static remote = new Remote(
    'https://6ix5m63wbo2ilup2arzisublzu0isdcz.lambda-url.us-east-1.on.aws/'
  );

  static async queryAddress(address: string): Promise<Response> {
    return await MultiversXService.remote.call(
      'MultiversXService.queryAddress',
      address
    );
  }
